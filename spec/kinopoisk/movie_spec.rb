...
describe Kinopoisk::Movie, vcr: { cassette_name: 'movies' } do
  ...
  it { dexter.imdb_rating_count.should be > 345000 }
  it { dexter.imdb_rating.should be_a(Float) }
  it { dexter.imdb_rating.should be_within(1.0).of(9.0) }
  it { dexter.rating_count.should be_a(Integer) }
  it { dexter.rating_count.should be > 50000 }  
  it { dexter.rating.should be_a(Float) }
  it { dexter.rating.should be_within(1.0).of(8.6) }
